...
const updateAccount2 = `-- name: UpdateAccount2 :one
/*
...
type UpdateAccount2Params struct {
	ID      int64 `json:"id"`
	Balance int64 `json:"balance"`
}

func (q *Queries) UpdateAccount2(ctx context.Context, arg UpdateAccount2Params) (Account, error) {
	row := q.db.QueryRowContext(ctx, updateAccount2, arg.ID, arg.Balance)
	var i Account
	err := row.Scan(
		&i.ID,
		&i.Owner,
